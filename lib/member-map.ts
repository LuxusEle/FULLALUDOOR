...
const MEMBER_SPECS: Record<TypologyId, RawMemberSpec[]> = {
  '100D-single': [
    ...
    group('upper-bead', 'Upper Glazing Bead', 'B-U', 'horizontal'),
    group('lower-bead', 'Lower Glazing Bead', 'B-L', 'horizontal'),
  ],
  '100D-double': [
    instance('left-jamb', 'Left Jamb', 'F-J', 1, 'vertical'),
    instance('right-jamb', 'Right Jamb', 'F-J', 2, 'vertical'),
    ...
    group('glazing-bead', 'Glazing Beads', 'B-D', 'horizontal'),
  ],
  '100S-sliding-2p': [
...
const META: Record<string, { code: string; type: string; category: MemberCategory }> = {
  ...
  'upper-bead': { code: 'UB', type: 'GLAZING BEAD', category: 'Bead' },
  'lower-bead': { code: 'LB', type: 'GLAZING BEAD', category: 'Bead' },
  'glazing-bead': { code: 'GB', type: 'GLAZING BEAD', category: 'Bead' },
